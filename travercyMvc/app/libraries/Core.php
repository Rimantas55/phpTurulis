...
class Core 
{
	...
	public function __construct()
	{
		...
		//echo $this->currentMethod;//here we checked if we get in browser method name

		// Get params
		$this->params = $url ? array_values($url) : [];//if there is parameters it add it, if not it just will stay empty array
